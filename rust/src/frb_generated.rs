...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1186484724;
...
fn wire__web_audio_api__worklet__AudioWorkletNode_disconnect_dest_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "AudioWorkletNode_disconnect_dest", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
...
let api_dest = <RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<dyn AudioNode>>>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse((move ||  {
                        let mut api_that_decoded = None;
...
let api_dest = api_dest_decoded.unwrap();
 Result::<_,()>::Ok({ web_audio_api::worklet::AudioWorkletNode::disconnect_dest(&api_that, &api_dest); })
                    })())
                } })
}
...
fn wire__web_audio_api__worklet__AudioWorkletNode_disconnect_dest_from_output_to_input_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "AudioWorkletNode_disconnect_dest_from_output_to_input", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_that = <RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<AudioWorkletNode>>>::sse_decode(&mut deserializer);
let api_dest = <RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<dyn AudioNode>>>::sse_decode(&mut deserializer);
let api_output = <usize>::sse_decode(&mut deserializer);
let api_input = <usize>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse((move ||  {
                        let mut api_that_decoded = None;
let mut api_dest_decoded = None;
let decode_indices_ = flutter_rust_bridge::for_generated::rust_auto_opaque_decode_compute_order(vec![flutter_rust_bridge::for_generated::rust_auto_opaque_lock_order_info(&api_that, 0, false), flutter_rust_bridge::for_generated::rust_auto_opaque_lock_order_info(&api_dest, 1, false)]);
...
1 => api_dest_decoded = Some(flutter_rust_bridge::for_generated::rust_auto_opaque_decode_sync_ref(&api_dest)),
        ...
        let api_that = api_that_decoded.unwrap();
let api_dest = api_dest_decoded.unwrap();
 Result::<_,()>::Ok({ web_audio_api::worklet::AudioWorkletNode::disconnect_dest_from_output_to_input(&api_that, &api_dest, api_output, api_input); })
                    })())
                } })
}
...
fn wire__web_audio_api__worklet__AudioWorkletNode_set_onprocessorerror_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "AudioWorkletNode_set_onprocessorerror", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            let message = unsafe { flutter_rust_bridge::for_generated::Dart2RustMessageSse::from_wire(ptr_, rust_vec_len_, data_len_) };
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_that = <RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<AudioWorkletNode>>>::sse_decode(&mut deserializer);
let api_callback = <Box < dyn FnOnce (ErrorEvent) + Send + 'static >>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse((move ||  {
                        let mut api_that_decoded = None;
let decode_indices_ = flutter_rust_bridge::for_generated::rust_auto_opaque_decode_compute_order(vec![flutter_rust_bridge::for_generated::rust_auto_opaque_lock_order_info(&api_that, 0, false)]);
        for i in decode_indices_ {
        ...
        let api_that = api_that_decoded.unwrap();
 Result::<_,()>::Ok({ web_audio_api::worklet::AudioWorkletNode::set_onprocessorerror(&api_that, api_callback); })
                    })())
                } })
}
...
flutter_rust_bridge::frb_generated_moi_arc_impl_value!(
    flutter_rust_bridge::for_generated::RustAutoOpaqueInner<dyn AudioNode>
);
...
impl SseDecode for Box<dyn FnOnce(ErrorEvent) + Send + 'static> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut inner = <RustOpaqueMoi<
            flutter_rust_bridge::for_generated::RustAutoOpaqueInner<
...
impl SseDecode
    for RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<dyn AudioNode>>
{
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut inner = <usize>::sse_decode(deserializer);
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        67 => wire__web_audio_api__context__AudioContext_sink_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        68 => wire__web_audio_api__context__AudioContext_suspend_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        69 => wire__web_audio_api__context__AudioContext_suspend_sync_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        70 => wire__web_audio_api__context__ConcreteBaseAudioContext_mark_cycle_breaker_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        71 => wire__web_audio_api__context__OfflineAudioContext_clear_oncomplete_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        72 => wire__web_audio_api__context__OfflineAudioContext_length_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        73 => wire__web_audio_api__context__OfflineAudioContext_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        74 => wire__web_audio_api__context__OfflineAudioContext_resume_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        75 => wire__web_audio_api__context__OfflineAudioContext_start_rendering_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        76 => wire__web_audio_api__context__OfflineAudioContext_start_rendering_sync_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        77 => wire__web_audio_api__context__OfflineAudioContext_suspend_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        78 => wire__web_audio_api__media_devices__get_user_media_sync_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        85 => wire__web_audio_api__media_recorder__MediaRecorder_clear_ondataavailable_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        86 => wire__web_audio_api__media_recorder__MediaRecorder_clear_onerror_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        87 => wire__web_audio_api__media_recorder__MediaRecorder_clear_onstop_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        88 => wire__web_audio_api__media_recorder__MediaRecorder_new_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        89 => wire__web_audio_api__media_recorder__MediaRecorder_start_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        90 => wire__web_audio_api__media_recorder__MediaRecorder_stop_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        91 => wire__web_audio_api__media_streams__MediaStreamTrack_close_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        92 => wire__web_audio_api__media_streams__MediaStreamTrack_ready_state_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        93 => wire__web_audio_api__media_streams__MediaStream_from_tracks_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        94 => wire__web_audio_api__media_streams__MediaStream_get_tracks_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        96 => wire__web_audio_api__node__AnalyserNode_frequency_bin_count_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        97 => wire__web_audio_api__node__AnalyserNode_max_decibels_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        98 => wire__web_audio_api__node__AnalyserNode_min_decibels_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        99 => wire__web_audio_api__node__AnalyserNode_set_fft_size_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        100 => wire__web_audio_api__node__AnalyserNode_set_max_decibels_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        101 => wire__web_audio_api__node__AnalyserNode_set_min_decibels_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        102 => wire__web_audio_api__node__AnalyserNode_set_smoothing_time_constant_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        103 => wire__web_audio_api__node__AnalyserNode_smoothing_time_constant_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        104 => wire__web_audio_api__node__AudioBufferSourceNode_detune_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        105 => wire__web_audio_api__node__AudioBufferSourceNode_loop__impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        106 => wire__web_audio_api__node__AudioBufferSourceNode_loop_end_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        107 => wire__web_audio_api__node__AudioBufferSourceNode_loop_start_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        108 => wire__web_audio_api__node__AudioBufferSourceNode_playback_rate_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        109 => wire__web_audio_api__node__AudioBufferSourceNode_position_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        110 => wire__web_audio_api__node__AudioBufferSourceNode_set_buffer_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        111 => wire__web_audio_api__node__AudioBufferSourceNode_set_loop_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        112 => wire__web_audio_api__node__AudioBufferSourceNode_set_loop_end_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        113 => wire__web_audio_api__node__AudioBufferSourceNode_set_loop_start_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        114 => wire__web_audio_api__node__AudioBufferSourceNode_start_at_with_offset_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        116 => wire__web_audio_api__node__AudioDestinationNode_max_channel_count_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        117 => wire__web_audio_api__node__BiquadFilterNode_detune_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        118 => wire__web_audio_api__node__BiquadFilterNode_frequency_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        121 => wire__web_audio_api__node__BiquadFilterNode_set_type_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        122 => wire__web_audio_api__node__BiquadFilterNode_type__impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        123 => wire__web_audio_api__node__ConstantSourceNode_offset_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        124 => wire__web_audio_api__node__ConvolverNode_normalize_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        125 => wire__web_audio_api__node__ConvolverNode_set_buffer_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        126 => wire__web_audio_api__node__ConvolverNode_set_normalize_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        128 => wire__web_audio_api__node__DynamicsCompressorNode_attack_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        129 => wire__web_audio_api__node__DynamicsCompressorNode_knee_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        130 => wire__web_audio_api__node__DynamicsCompressorNode_ratio_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        131 => wire__web_audio_api__node__DynamicsCompressorNode_reduction_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        132 => wire__web_audio_api__node__DynamicsCompressorNode_release_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        133 => wire__web_audio_api__node__DynamicsCompressorNode_threshold_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        134 => wire__web_audio_api__node__GainNode_gain_impl(port, ptr, rust_vec_len, data_len),
        135 => wire__web_audio_api__node__MediaStreamAudioDestinationNode_stream_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        137 => wire__web_audio_api__node__OscillatorNode_frequency_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        138 => wire__web_audio_api__node__OscillatorNode_set_periodic_wave_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        139 => wire__web_audio_api__node__OscillatorNode_set_type_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        141 => wire__web_audio_api__node__PannerNode_cone_inner_angle_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        142 => wire__web_audio_api__node__PannerNode_cone_outer_angle_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        143 => wire__web_audio_api__node__PannerNode_cone_outer_gain_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        144 => wire__web_audio_api__node__PannerNode_distance_model_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        145 => wire__web_audio_api__node__PannerNode_max_distance_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        146 => wire__web_audio_api__node__PannerNode_orientation_x_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        147 => wire__web_audio_api__node__PannerNode_orientation_y_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        148 => wire__web_audio_api__node__PannerNode_orientation_z_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        149 => wire__web_audio_api__node__PannerNode_panning_model_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        153 => wire__web_audio_api__node__PannerNode_ref_distance_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        154 => wire__web_audio_api__node__PannerNode_rolloff_factor_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        155 => wire__web_audio_api__node__PannerNode_set_cone_inner_angle_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        156 => wire__web_audio_api__node__PannerNode_set_cone_outer_angle_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        157 => wire__web_audio_api__node__PannerNode_set_cone_outer_gain_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        158 => wire__web_audio_api__node__PannerNode_set_distance_model_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        159 => wire__web_audio_api__node__PannerNode_set_max_distance_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        160 => wire__web_audio_api__node__PannerNode_set_orientation_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        161 => wire__web_audio_api__node__PannerNode_set_panning_model_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        162 => wire__web_audio_api__node__PannerNode_set_position_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        163 => wire__web_audio_api__node__PannerNode_set_ref_distance_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        164 => wire__web_audio_api__node__PannerNode_set_rolloff_factor_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        165 => wire__web_audio_api__node__ScriptProcessorNode_buffer_size_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        166 => wire__web_audio_api__node__ScriptProcessorNode_clear_onaudioprocess_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        168 => wire__web_audio_api__node__WaveShaperNode_oversample_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        169 => wire__web_audio_api__node__WaveShaperNode_set_curve_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        170 => wire__web_audio_api__node__WaveShaperNode_set_oversample_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        171 => wire__web_audio_api__worklet__AudioWorkletNode_channel_config_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        172 => wire__web_audio_api__worklet__AudioWorkletNode_channel_count_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        173 => wire__web_audio_api__worklet__AudioWorkletNode_channel_count_mode_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        174 => wire__web_audio_api__worklet__AudioWorkletNode_channel_interpretation_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        175 => wire__web_audio_api__worklet__AudioWorkletNode_clear_onprocessorerror_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        176 => wire__web_audio_api__worklet__AudioWorkletNode_context_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        177 => wire__web_audio_api__worklet__AudioWorkletNode_disconnect_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        178 => wire__web_audio_api__worklet__AudioWorkletNode_disconnect_dest_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        179 => wire__web_audio_api__worklet__AudioWorkletNode_disconnect_dest_from_output_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        181 => wire__web_audio_api__worklet__AudioWorkletNode_disconnect_output_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        182 => wire__web_audio_api__worklet__AudioWorkletNode_number_of_inputs_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        183 => wire__web_audio_api__worklet__AudioWorkletNode_number_of_outputs_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        184 => wire__web_audio_api__worklet__AudioWorkletNode_parameters_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        185 => wire__web_audio_api__worklet__AudioWorkletNode_registration_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        186 => wire__web_audio_api__worklet__AudioWorkletNode_set_channel_count_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        187 => wire__web_audio_api__worklet__AudioWorkletNode_set_channel_count_mode_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        188 => wire__web_audio_api__worklet__AudioWorkletNode_set_channel_interpretation_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        189 => wire__web_audio_api__worklet__AudioWorkletNode_set_onprocessorerror_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        79 => wire__web_audio_api__media_recorder__BlobEvent_get_blob_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        80 => wire__web_audio_api__media_recorder__BlobEvent_get_event_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        81 => wire__web_audio_api__media_recorder__BlobEvent_get_timecode_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        82 => wire__web_audio_api__media_recorder__BlobEvent_set_blob_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        83 => wire__web_audio_api__media_recorder__BlobEvent_set_event_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        84 => wire__web_audio_api__media_recorder__BlobEvent_set_timecode_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for FrbWrapper<Box<dyn FnOnce(ErrorEvent) + Send + 'static>> {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        flutter_rust_bridge::for_generated::rust_auto_opaque_encode::<_, MoiArc<_>>(self.0)
            .into_dart()
    }
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for FrbWrapper<Box<dyn FnOnce(ErrorEvent) + Send + 'static>>
{
}

impl flutter_rust_bridge::IntoIntoDart<FrbWrapper<Box<dyn FnOnce(ErrorEvent) + Send + 'static>>>
    for Box<dyn FnOnce(ErrorEvent) + Send + 'static>
{
    fn into_into_dart(self) -> FrbWrapper<Box<dyn FnOnce(ErrorEvent) + Send + 'static>> {
        self.into()
    }
}
...
impl SseEncode for Box<dyn FnOnce(ErrorEvent) + Send + 'static> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <RustOpaqueMoi<
            flutter_rust_bridge::for_generated::RustAutoOpaqueInner<
