...
// These functions are ignored because they are not marked as `pub`: `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `clone`, `clone`, `clone`, `clone`, `clone`, `count_mode`, `count`, `default`, `default`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `from`, `from`, `from`, `inner`, `interpretation`, `set_count_mode`, `set_count`, `set_interpretation`
