...
// These functions are ignored because they are not marked as `pub`: `before_drop`, `channel_config`, `clone`, `clone`, `clone`, `clone`, `default`, `default`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `handle_control_message`, `number_of_inputs`, `number_of_outputs`, `onmessage`, `process`, `registration`, `start_at`, `start`, `stop_at`, `stop`
