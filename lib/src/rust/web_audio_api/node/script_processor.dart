...
// These functions are ignored because they are not marked as `pub`: `clone`, `fmt`, `fmt`, `registration`, `channel_config`, `number_of_inputs`, `number_of_outputs`, `set_channel_count_mode`, `set_channel_count`, `process`, `onmessage`
