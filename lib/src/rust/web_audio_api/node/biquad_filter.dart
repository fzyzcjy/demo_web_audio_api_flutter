...
// These functions are ignored because they are not marked as `pub`: `assert_receiver_is_total_eq`, `calculate_coefs`, `channel_config`, `clone`, `clone`, `clone`, `default`, `default`, `default`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `from`, `get_computed_freq`, `number_of_inputs`, `number_of_outputs`, `onmessage`, `process`, `registration`
