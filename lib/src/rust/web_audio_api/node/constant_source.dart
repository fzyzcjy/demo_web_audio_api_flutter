...
// These functions are ignored because they are not marked as `pub`: `clone`, `fmt`, `default`, `fmt`, `clone`, `fmt`, `registration`, `channel_config`, `number_of_inputs`, `number_of_outputs`, `start`, `start_at`, `stop`, `stop_at`, `process`, `onmessage`, `before_drop`
