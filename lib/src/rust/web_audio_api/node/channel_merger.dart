...
// These functions are ignored because they are not marked as `pub`: `assert_valid_channel_count_mode`, `assert_valid_channel_count`, `assert_valid_number_of_channels`, `channel_config`, `clone`, `default`, `fmt`, `fmt`, `fmt`, `number_of_inputs`, `number_of_outputs`, `process`, `registration`, `set_channel_count_mode`, `set_channel_count`
