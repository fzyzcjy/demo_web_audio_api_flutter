...
// These functions are ignored because they are not marked as `pub`: `assert_valid_number_of_channels`, `assert_valid_channel_count`, `assert_valid_channel_count_mode`, `assert_valid_channel_interpretation`, `clone`, `fmt`, `default`, `fmt`, `registration`, `channel_config`, `set_channel_count`, `set_channel_count_mode`, `set_channel_interpretation`, `number_of_inputs`, `number_of_outputs`, `fmt`, `process`
