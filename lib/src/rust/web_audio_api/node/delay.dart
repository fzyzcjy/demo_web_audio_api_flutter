...
// These functions are ignored because they are not marked as `pub`: `channel_config`, `check_ring_buffer_up_down_mix`, `clone`, `clone`, `connect_from_output_to_input`, `default`, `default`, `disconnect_dest_from_output_to_input`, `disconnect_dest_from_output`, `disconnect_dest`, `disconnect_output`, `disconnect`, `drop`, `fmt`, `fmt`, `fmt`, `get_playback_infos`, `has_side_effects`, `number_of_inputs`, `number_of_outputs`, `process`, `process`, `registration`, `ring_buffer_mut`, `ring_buffer_mut`
// These types are ignored because they are not used by any `pub` functions: `DelayReader`, `DelayWriter`, `PlaybackInfo`
