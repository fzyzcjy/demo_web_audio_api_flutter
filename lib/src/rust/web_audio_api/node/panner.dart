...
// These functions are ignored because they are not marked as `pub`: `apply_mono_to_stereo_gain`, `apply_stereo_to_stereo_gain`, `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `assert_valid_channel_count_mode`, `assert_valid_channel_count`, `assert_valid_cone_outer_gain`, `channel_config`, `clone`, `clone`, `clone`, `clone`, `cone_gain`, `default`, `default`, `default`, `dist_gain`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `from`, `from`, `load_hrtf_processor`, `new`, `number_of_inputs`, `number_of_outputs`, `onmessage`, `process`, `process`, `registration`, `set_channel_count_mode`, `set_channel_count`, `tail_time_samples`
// These types are ignored because they are not used by any `pub` functions: `ControlMessage`, `HrtfState`, `PannerRenderer`, `SpatialParams`
