...
// These functions are ignored because they are not marked as `pub`: `assert_valid_feedback_coefs`, `assert_valid_feedforward_coefs`, `channel_config`, `clone`, `fmt`, `fmt`, `new`, `number_of_inputs`, `number_of_outputs`, `process`, `registration`
