...
// These functions are ignored because they are not marked as `pub`: `normalize_buffer`, `roll_zero`, `clone`, `fmt`, `default`, `fmt`, `registration`, `channel_config`, `number_of_inputs`, `number_of_outputs`, `new`, `real`, `complex`, `process`, `inverse`, `new`, `process`, `tail`, `process`, `onmessage`
// These types are ignored because they are not used by any `pub` functions: `Fft`, `ConvolverRendererInner`, `ConvolverRenderer`
